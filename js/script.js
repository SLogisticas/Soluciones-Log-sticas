// Funcionalidad de loader - VERSIÓN CORREGIDA
...
// FALLBACK: Ocultar loader después de 5 segundos máximo
setTimeout(() => {
    const loader = document.getElementById('loader');
...
modalImage.addEventListener('wheel', (e) => {
    ...
    const newScale = e.deltaY < 0 ? currentScale * 1.1 : currentScale / 1.1;
...
document.addEventListener('DOMContentLoaded', async () => {
    const scriptURL = 'https://script.google.com/macros/s/AKfycbzzW4pWj_f_yL7o89y93XQ9fLqJv2t2qF0_g_F_x/exec';
        ...
        try {
            ...
            if (data && data.length > 0) {
                data.forEach(t => {
                    ...
                    `;
                    contenedorTestimonios.prepend(tarjeta);
                });
            } else {
